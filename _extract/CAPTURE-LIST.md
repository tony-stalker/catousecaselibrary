...
Generated 23 Jul 2026 from `<!-- capture-wanted: ... -->` comments (199 captures across 57 pages).
Re-generate: grep -rn 'capture-wanted' usecases/*.html. Capture in one CMA session per area,
convert per image-catalog conventions, then tell Claude which pages to embed them on.
...
## Access — Posture & Client policies (16)
...
## Security — DLP & Data Protection (11)
